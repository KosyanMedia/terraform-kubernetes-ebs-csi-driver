resource "kubernetes_manifest" "customresourcedefinition_volumesnapshots_snapshot_storage_k8s_io" {
...
resource "kubernetes_manifest" "customresourcedefinition_volumesnapshotcontents_snapshot_storage_k8s_io" {
  count = var.enable_volume_snapshot ? 1 : 0
...
resource "kubernetes_manifest" "customresourcedefinition_volumesnapshotclasses_snapshot_storage_k8s_io" {
  count = var.enable_volume_snapshot ? 1 : 0
